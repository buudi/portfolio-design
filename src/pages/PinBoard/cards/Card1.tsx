...
export default function PostWithLike() {
  ...
  return (
    // <Center py={6}>
      ...
      >
        <Flex p={"5px"} justify={"space-between"} borderBottom={"1px solid black"}>
            
          <Heading color={"black"} fontSize={"xl"}>2.</Heading><Text fontWeight={"semibold"} mr={"1.5rem"}>Medium.com </Text>
        </Flex>
